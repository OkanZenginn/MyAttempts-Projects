...
counto = 0
winner = None
width = int(input("Please enter the height and width of the board:   "))
height = width
white = (255, 255, 255)
...
screen = pg.display.set_mode((width, height + 50), 0, 32)  # this function determines width and height of the game window
...
opening = pg.transform.scale(opening, (width, height + 50))
...
def draw_status():  # this function control's the subtext and game progress
    global winner, XO, counto, countx, width
    if winner is None:
    ...
    font = pg.font.Font(None, int(width/20))  # this function arranges the font of the subtext
    text = font.render(message, True, (255, 255, 255))  # this function arranges subtext's contents and color.

    # copy the rendered message onto the board
    screen.fill((0, 0, 0), (0, width, height+50, 100))
...
def check_win():  # this function checks if the XXX or OOO happened in any column or row or diagonally.  If there are, function draws a line on it
        ...
        for b in range(0, size - 2):
            if (TTT[a][b] == TTT[a][b + 1] == TTT[a][b + 2]) and (TTT[a][b] is not None and TTT[a][b] == 'x'):
                pg.draw.line(screen, (250, 0, 0), (b * (width / size), a * height / size + height / (size * 2)),
                             ((b + 3) * (width / size), (a * (height / size) + height / (size * 2))), 4)
                countx += 1
    ...
    for a in range(0, size - 2):
        for b in range(0, size):
            if (TTT[a][b] == TTT[a + 1][b] == TTT[a + 2][b]) and (TTT[a][b] is not None and TTT[a][b] == 'x'):
                pg.draw.line(screen, (250, 250, 0), ((b * (width / size) + (width / (size * 2))), (a * height / size)),
                             (((b * (width / size)) + width / (size * 2)), ((a + 3) * (height / size))), 4)
                countx += 1
            elif (TTT[a][b] == TTT[a + 1][b] == TTT[a + 2][b]) and (TTT[a][b] is not None and TTT[a][b] == 'o'):
                pg.draw.line(screen, (0, 250, 250), ((b * (width / size) + (width / (size * 2))), (a * height / size)),
                             (((b * (width / size)) + width / (size * 2)), ((a + 3) * (height / size))), 4)
                counto += 1
    ...
    for a in range(0, size - 2):
        for b in range(0, size - 2):
            if (TTT[a][b] == TTT[a + 1][b + 1] == TTT[a + 2][b + 2]) and (TTT[a][b] is not None and TTT[a][b] == 'x'):
                pg.draw.line(screen, (250, 0, 250), ((b * width / size), (a * height / size)),
                             (((b + 3) * width / size), ((a + 3) * height / size)), 4)
                countx += 1

            elif (TTT[a][b] == TTT[a + 1][b + 1] == TTT[a + 2][b + 2]) and (TTT[a][b] is not None and TTT[a][b] == 'o'):
                pg.draw.line(screen, (100, 100, 250), ((b * width / size), (a * height / size)),
                             (((b + 3) * width / size), ((a + 3) * height / size)), 4)
                counto += 1
    ...
    for a in range(0, size - 2):
        for b in range(2, size):
            if (TTT[a][b] == TTT[a + 1][b - 1] == TTT[a + 2][b - 2]) and (TTT[a][b] is not None and TTT[a][b] == 'x'):
                pg.draw.line(screen, (250, 0, 250), (((b - 2) * width / size), ((a + 3) * height / size)),
                             (((b + 1) * width / size), (a * height / size)), 4)
                countx += 1

            elif (TTT[a][b] == TTT[a + 1][b - 1] == TTT[a + 2][b - 2]) and (TTT[a][b] is not None and TTT[a][b] == 'o'):
                pg.draw.line(screen, (100, 100, 250), (((b - 2) * width / size), ((a + 3) * height / size)),
                             (((b + 1) * width / size), (a * height / size)), 4)
                counto += 1
